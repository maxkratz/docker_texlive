...
**Please notice**: TeX Live <= 2025 is frozen forever according to [tuc.org](https://www.tug.org/texlive/).
...
It is used as a base for the other builds and builds on top of the [ubuntu 26.04 image](https://hub.docker.com/_/ubuntu).
